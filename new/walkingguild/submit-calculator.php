<?php
//Connect to database - COMMENTED OUT BECAUSE NOT HOOKED UP TO DB ANYMORE
...
if ($minwalking >= 30) { // redirect to get them to sign up 
	header('Location: http://www.cath.lu/walkingguild/congrats.php?t=' . $minwalking);	
	exit;
} else {
	header('Location: http://www.cath.lu/walkingguild/result.php?t=' . $minwalking);	
	exit;
}
?>